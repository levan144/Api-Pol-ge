<?php
// /api/test/branches/{branchNo}/customers/{customerMiaId}/items/{itemMiaId} დაგირავებული ნივთის მონაცემების ცვლილება
$url = "https://api.pol.ge/api/test/branches/1/customers/1/items/1";
